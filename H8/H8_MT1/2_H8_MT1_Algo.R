...
V1 <- as.numeric(length(Algo_MT1_H8_Datos$Precios_H_1[,1]) - Tam_Ventana)
V2 <- as.numeric(length(Algo_MT1_H8_Datos$Precios_H_1[,1]))

Datos <- Algo_MT1_H8_Datos$Precios_H_1[V1:V2,]
...
Trade  <- PredSide
TPBuy  <- Algo_MT1_H8_Datos$Precios_A_1$Bid + TakeProfit/MultPip1
TPSell <- Algo_MT1_H8_Datos$Precios_A_1$Ask - TakeProfit/MultPip1
SLBuy  <- Algo_MT1_H8_Datos$Precios_A_1$Bid - StopLoss/MultPip1
SLSell <- Algo_MT1_H8_Datos$Precios_A_1$Ask + StopLoss/MultPip1

Algo_MT1_H8_Datos$Finales <- list(
                              Inst  = Inst_H8,
                              Trade = Trade,
