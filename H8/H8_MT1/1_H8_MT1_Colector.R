...
# -- Precios
Algo_MT1_H8_Datos <- list(

  Precios_H_1 = HisPrices(OA_At,Per,OA_Da,OA_Ta,OA_Ak,Inst_H8,NULL,NULL,900),
  Precios_A_1 = list(Bid = ActualPrice(OA_At,OA_Ak,Inst_H8)$Bid,
                     Ask = ActualPrice(OA_At,OA_Ak,Inst_H8)$Ask)
)
