...
pkg <- c("base","downloader","fBasics","forecast","grid","gridExtra","httr","jsonlite",
         "knitr","lubridate","moments","PerformanceAnalytics","plyr","quantmod",
         "reshape2","RCurl","stats","scales","tree","tseries","TTR","TSA","twitteR",
         "XML","xts","xlsx","zoo")
...
source('~/Documents/GitHub/MachineTradeR/MTR_Notifier/MTR_Notifier.R', echo=TRUE)
...
source('~/Documents/GitHub/MachineTradeR/MTR_BackUp/MTR_BackUp.R', echo=TRUE)
