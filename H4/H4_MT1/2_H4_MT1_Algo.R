...
Trade  <- PredSide
TPBuy  <- Algo_MT1_H4_Datos$Precios_A_1$Bid + TakeProfit/MultPip1
TPSell <- Algo_MT1_H4_Datos$Precios_A_1$Ask - TakeProfit/MultPip1
SLBuy  <- Algo_MT1_H4_Datos$Precios_A_1$Bid - StopLoss/MultPip1
SLSell <- Algo_MT1_H4_Datos$Precios_A_1$Ask + StopLoss/MultPip1
